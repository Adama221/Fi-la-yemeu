          ...
          <div className="space-y-12">
            ...
            <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <input type="text" placeholder="PRÉNOM" value={customerInfo.prenom} onChange={e => setCustomerInfo({...customerInfo, prenom: e.target.value})} className="bg-white border border-primary/10 p-5 text-[10px] font-bold tracking-widest outline-none focus:border-secondary transition-colors uppercase rounded-2xl shadow-sm" />
                  <input type="text" placeholder="NOM" value={customerInfo.nom} onChange={e => setCustomerInfo({...customerInfo, nom: e.target.value})} className="bg-white border border-primary/10 p-5 text-[10px] font-bold tracking-widest outline-none focus:border-secondary transition-colors uppercase rounded-2xl shadow-sm" />
                  <div className="md:col-span-2">
                    <input type="text" placeholder="ADRESSE À DAKAR" value={customerInfo.adresse} onChange={e => setCustomerInfo({...customerInfo, adresse: e.target.value})} className="w-full bg-white border border-primary/10 p-5 text-[10px] font-bold tracking-widest outline-none focus:border-secondary transition-colors uppercase rounded-2xl shadow-sm" />
                  </div>
                  <input type="tel" placeholder="TÉLÉPHONE (+221)" value={customerInfo.telephone} onChange={e => setCustomerInfo({...customerInfo, telephone: e.target.value})} className="bg-white border border-primary/10 p-5 text-[10px] font-bold tracking-widest outline-none focus:border-secondary transition-colors uppercase rounded-2xl shadow-sm" />
                  <input type="email" placeholder="EMAIL" value={customerInfo.email} onChange={e => setCustomerInfo({...customerInfo, email: e.target.value})} className="bg-white border border-primary/10 p-5 text-[10px] font-bold tracking-widest outline-none focus:border-secondary transition-colors uppercase rounded-2xl shadow-sm" />
                </div>
            </section>
